...
const createPost = (payload, files) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield product_model_1.Posts.create(payloadData);
    return result;
});
const getAllPosts = () => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield product_model_1.Posts.find().populate('authorId');
    return result;
});
const getMostUpvotedPost = () => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield product_model_1.Posts.find().sort({ "upvotes.length": -1 });
    return result;
});
const getSinglePostById = (postId) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield product_model_1.Posts.findById(postId);
    return result;
});
const updatePost = (postId, payload, files) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield product_model_1.Posts.findByIdAndUpdate(postId, Object.assign(Object.assign({}, payload), { images: imageUrls }), // Merge new image URLs with existing data
    { new: true, runValidators: true });
    return result;
});
const deletePost = (postId) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield product_model_1.Posts.findByIdAndDelete(postId);
    return result;
});
const upvotePost = (postId, userId) => __awaiter(void 0, void 0, void 0, function* () {
    const post = yield product_model_1.Posts.findById(postId);
    if (!post) {
...
const editComment = (commentId, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const post = yield product_model_1.Posts.findById(payload.postId);
